...
/**
 * check_elf - This will check if file is an ELF file.
...
/**
 * print_magic - This will print magic num of an ELF header.
...
/**
 * print_data - This will print data of an ELF header.
...
/**
 * print_entry - This will prints the entry point of an ELF header.
...
/**
 * main - This displays the information contained in
